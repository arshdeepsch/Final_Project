...
C_E,hex7,hex6,hex5,hex4,hex3,hex2,hex1,hex0);
input Clock, Resetn;
input S_A,C_A,C_1,C_0;
output S_D,C_D,C_E;
output reg [3:0] hex7,hex6,hex5,hex4,hex3,hex2,hex1,hex0;
reg [2:0] Y;
...
A: if ({C_1} == 1'b1 | {C_0} == 1'b1) Y <= B;
   else begin Y <= A; hex7=4'h0; hex6=4'h0 ;hex5=4'h0; hex4=4'h0; hex3 = 4'h0; hex2 = 4'h0;hex1 = 4'h0; hex0 = 4'h0; end
B: if ({C_1,C_0} == 2'b11) Y <= C;
   else if({S_A} == 1'b1) Y<= G;
   else if({C_A} == 1'b1) Y<= E;
   else begin Y <= B; hex7=4'h0; hex6=4'h0 ;hex5=4'h0; hex4=4'h0;hex3 = 4'h0; hex2 = 4'h0; hex1 = 4'h2; hex0 = 4'h5; end
C: if ({S_A} == 1'b1) Y <= D;
