...
HD_PWD='C:/Users/Ronak/Final_Project/Final_Project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Vending.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Vending.tcl -notrace
